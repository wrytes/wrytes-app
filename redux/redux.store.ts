...
import { addressColorsReducer } from './slices/addressColors.slice';
// transforms
...
const rootReducer = combineReducers({
	...
	addressColors: addressColorsReducer,
});
...
const persistConfig = {
	...
	version: 1,
	storage,
	whitelist: ['transactionQueue', 'krakenCredentials', 'addressColors'],
